...
function windowResizeEventListener(canvas, camera, renderer) {
    ...
    window.onresize = () => windowResizeEventListener(canvas, camera, renderer)
}
...
async function loadComputer() {
    ...
    windowResizeEventListener(oldCanvas, camera, renderer)
